...
public class MqttClientManager {
    ...
    private static final Map<String, MqttAbstractNode> CLIENT_MAP = new ConcurrentHashMap<>();

    /** 创建MqttClient连接，若已存在则复用连接，若不存在则创建连接 */
    public static void createMqttClient(MqttAbstractNode node) {
    ...
    /** 关闭MqttClient连接 */
    public static void closeMqttClient(MqttAbstractNode node) {
    ...
    /** 是否包含相同节点 */
    public static boolean contains(MqttAbstractNode node) {
